...
setupCodeEmission(computedLatexCode, emit, props.componentId, 'TitleFormatPackage')
...
<template>
  <div class="package-options-dialog">
    <!-- 触发弹窗的按钮 -->
    <el-button v-if="!props.externalTrigger" type="primary" size="small" round @click="openDialog">标题格式设置</el-button>
