...
public class Loader
{
     ...
     *
     * @param filename The name of the file to load. {@link RandomAccessReadBufferedFile} is used
     * to read the file.
     *
     ...
     * This will load a document from a file.
     *
     * @param file The name of the file to load. {@link RandomAccessReadBufferedFile} is used to
     * read the file.
     *
     * @return The document that was loaded.
     *
     ...
     * {@link RandomAccessReadBuffer} is used
     *
     * @return The document that was loaded.
     *
     * @throws IOException If there is an error reading from the stream.
     ...
     * 
     * @param input byte array that contains the document. {@link RandomAccessReadBuffer} is used
     * to read the data.
     * 
     ...
     * Parses a PDF. Unrestricted main memory will be used for buffering PDF streams.
     * 
     * @param file file to be loaded. {@link RandomAccessReadBufferedFile} is used to read the
     * file.
     * 
     * @return loaded document
     * 
