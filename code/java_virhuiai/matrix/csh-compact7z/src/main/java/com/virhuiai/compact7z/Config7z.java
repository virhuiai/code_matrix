...
public class Config7z extends HashMap<String, String> {
    private static final Log LOGGER = LogFactory.getLog(Config7z.class);
    ...
    private void processPassword() {
        ...
        String password = CliUtils.s3GetOptionValue("p", randomMD5);
...
//        String defaultValue = get(Keys.PASSWORD_PREFIX);
        String defaultValue = "";
        String prefix = CliUtils.s3GetOptionValue("passwordPrefix", defaultValue);
...
//        String defaultValue = get(Keys.PASSWORD_SUFFIX);
        String defaultValue = "";
        String suffix = CliUtils.s3GetOptionValue("passwordSuffix", defaultValue);
    ...
    private void processCompressionLevel() {
        String levelStr = CliUtils.s3GetOptionValue("l", Defaults.DEFAULT_COMPRESSION_LEVEL);
        int level;
    ...
    public void processOutputFile() {
        ...
        String output = CliUtils.s3GetOptionValue("o", defaultOutput);
