...
//        String expectedAtDepth1 = "com.virhuiai.log.string.ToStringTest$NestedObject:[outerName:Outer; innerObject:SimpleObject{name='Test', value=123, active=true}; items:[item1, item2]]";
