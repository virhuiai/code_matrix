...
/* loaded from: metamorphosis-24.02.0.jar:com/jgoodies/components/JGPasswordField.class */
public class JGPasswordField extends JPasswordField implements JGTextComponent2 {
    ...
    public JGPasswordField(String text) {
        super(text);
    }

    public JGPasswordField(int columns) {
        super(columns);
    }

    public JGPasswordField(String text, int columns) {
        super(text, columns);
    }

    public JGPasswordField(Document doc, String txt, int columns) {
    ...
    /* loaded from: metamorphosis-24.02.0.jar:com/jgoodies/components/JGPasswordField$AccessibleJGPasswordField.class */
    private final class AccessibleJGPasswordField extends AccessibleJPasswordField {
        ...
        public String getAccessibleDescription() {
            ...
            if (Objects.equals(name, JGPasswordField.this.getPrompt())) {
                return null;
            }
            return JGPasswordField.this.getPrompt();
        }
