...
/* loaded from: metamorphosis-24.02.0.jar:com/jgoodies/components/JGRadioButtonMenuItem.class */
public class JGRadioButtonMenuItem extends JRadioButtonMenuItem {
    ...
    public JGRadioButtonMenuItem(String text) {
        this(text, (Icon) null, false);
    }

    public JGRadioButtonMenuItem(String text, boolean selected) {
        this(text, (Icon) null, selected);
    }

    public JGRadioButtonMenuItem(Icon icon, boolean selected) {
    ...
    public JGRadioButtonMenuItem(String text, Icon icon) {
        this(text, icon, false);
    }

    public JGRadioButtonMenuItem(String text, Icon icon, boolean selected) {
        super(text, icon, selected);
        this.iconVisible = true;
    }

    public JGRadioButtonMenuItem(String text, int mnemonic) {
        this(text, (Icon) null, false);
        setMnemonic(mnemonic);
    }

    public JGRadioButtonMenuItem(String text, int mnemonic, boolean selected) {
        this(text, (Icon) null, selected);
        setMnemonic(mnemonic);
    }

    public JGRadioButtonMenuItem(String text, Icon icon, int mnemonic) {
        this(text, icon, false);
        setMnemonic(mnemonic);
    }

    public JGRadioButtonMenuItem(String text, Icon icon, int mnemonic, boolean selected) {
