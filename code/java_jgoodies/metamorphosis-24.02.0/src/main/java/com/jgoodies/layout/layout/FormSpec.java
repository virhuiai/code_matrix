...
/* loaded from: metamorphosis-24.02.0.jar:com/jgoodies/layout/layout/FormSpec.class */
public abstract class FormSpec implements Serializable {
    ...
    public FormSpec(DefaultAlignment defaultAlignment, Size size, double resizeWeight) {
        Preconditions.checkNotNull(size, Messages.MUST_NOT_BE_NULL, "size");
        Preconditions.checkArgument(resizeWeight >= NO_GROW, "The resize weight must be non-negative.");
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public FormSpec(DefaultAlignment defaultAlignment, String encodedDescription) {
    ...
    private void parseAndInitValues(String encodedDescription) {
        Preconditions.checkNotBlank(encodedDescription, Messages.MUST_NOT_BE_BLANK, "encoded form specification");
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final int maximumSize(Container container, List<Component> components, FormLayout.ComponentSizeCache sizeCache, FormLayout.Measure minMeasure, FormLayout.Measure prefMeasure, FormLayout.Measure defaultMeasure, boolean horizontal) {
        return this.size.maximumSize(container, components, sizeCache, minMeasure, prefMeasure, defaultMeasure, horizontal);
    }

    /* loaded from: metamorphosis-24.02.0.jar:com/jgoodies/layout/layout/FormSpec$DefaultAlignment.class */
