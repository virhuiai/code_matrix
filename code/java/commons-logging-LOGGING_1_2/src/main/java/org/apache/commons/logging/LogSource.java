 ...
 */
// ?????
// ?????LogSource ??????????? Log ????????? makeNewLogInstance() ??????? Log ??????
// ?????
// 1. ?? Log4J ????? Log4JLogger ???
// 2. ?? JDK 1.4 ?????????? Jdk14Logger ???
// 3. ????? NoOpLog ??????????
// ???????
// 1. ???????????? org.apache.commons.logging.log??? Log ?????????
// 2. ?????? setLogImplementation() ???
// ?????????????????? LogFactory ?????????????
...
public class LogSource {
    ...
    static {
        ...
        // ??????? Log4J ??????????
        // ????????? org.apache.log4j.Logger ?????? log4jIsAvailable ?? true???? false?
        // ???????????????????????
        ...
        // ??????? JDK 1.4 ?????????
        // ????????? java.util.logging.Logger ? Jdk14Logger ??????? jdk14IsAvailable ?? true?
        // ??????????????????????????
        ...
        // ?????
        // 1. ????????????????????????
        // 2. ??????????? Log4JLogger?Jdk14Logger ? NoOpLog?
        // 3. ?????????? NoOpLog????????
        // ?????????????????????????? NoOpLog ???????
    }
    ...
    static public void setLogImplementation(String classname)
        ...
        try {
            // Class.forName ? Java ? java.lang.Class ????????????????????fully qualified name????????? Java ????????????????????????????? Class ???
    ...
    // ?????logclass - ?? Log ?????
    // ????????? NoSuchMethodException?????????? SecurityException???????
    // ?????? setLogImplementation(String) ???????? Class ????????
